...
def newplot(title="Fedbatch cultivation", plotType="TimeSeries"):
    ...
    if plotType == "TimeSeries":
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(sim_res['time'],sim_res['bioreactor.c[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[1].plot(sim_res['time'],sim_res['bioreactor.c[6]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[2].plot(sim_res['time'],sim_res['bioreactor.c[5]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(sim_res['time'],sim_res['bioreactor.c[7]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[4].plot(sim_res['time'],sim_res['bioreactor.c[1]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(sim_res['time'],sim_res['bioreactor.c[2]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[7].plot(sim_res['time'],sim_res['bioreactor.V'], color='b', linestyle=linetype)"
        )
    ...
    if plotType == "TimeSeries1":
        ...
        diagrams.clear()
        diagrams.append(
            "ax11.plot(sim_res['time'],sim_res['bioreactor.c[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax12.plot(sim_res['time'],sim_res['bioreactor.c[6]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax21.plot(sim_res['time'],sim_res['bioreactor.c[5]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax22.plot(sim_res['time'],sim_res['bioreactor.c[7]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax31.plot(sim_res['time'],sim_res['bioreactor.c[1]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax32.plot(sim_res['time'],sim_res['bioreactor.c[2]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax32.plot(sim_res['time'],sim_res['bioreactor.c[3]'], color='k', linestyle=linetype)"
        )
        diagrams.append(
            "ax41.plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax42.plot(sim_res['time'],sim_res['bioreactor.V'], color='b', linestyle=linetype)"
        )
    ...
    if plotType == "TimeSeries2":
        ...
        diagrams.append(
            "ax[4].plot(sim_res['time'],sim_res['bioreactor.m[1]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(sim_res['time'],sim_res['bioreactor.c[2]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(sim_res['time'],sim_res['bioreactor.c[3]'], color='k', linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(sim_res['time'],sim_res['bioreactor.inlet[1].F'], color='b', linestyle=linetype)"
        )
    ...
    if plotType == "Textbook_1":
        ...
        ax12 = plt.subplot(5, 2, 2)
        ax21 = plt.subplot(5, 2, 3)
        ax22 = plt.subplot(5, 2, 4)
        ax31 = plt.subplot(5, 2, 5)
        ax32 = plt.subplot(5, 2, 6)
        ...
        diagrams.clear()
        diagrams.append(
            "ax11.plot(sim_res['time'],sim_res['bioreactor.c[3]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax12.plot(sim_res['time'],sim_res['bioreactor.c[5]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax21.plot(sim_res['time'],sim_res['bioreactor.c[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax22.plot(sim_res['time'],sim_res['bioreactor.c[6]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax31.plot(sim_res['time'],sim_res['bioreactor.c[1]'], color='b', linestyle=linetype)"
        )
        ...
        diagrams.append(
            "ax51.plot(sim_res['time'],sim_res['bioreactor.V'], color='b', linestyle=linetype)"
        )

    if plotType == "Textbook_2":

        plt.figure()
        ax11 = plt.subplot(5, 3, 1)
        ax12 = plt.subplot(5, 3, 2)
        ax13 = plt.subplot(5, 3, 3)
        ax21 = plt.subplot(5, 3, 4)
        ax22 = plt.subplot(5, 3, 5)
        ax23 = plt.subplot(5, 3, 6)
        ax31 = plt.subplot(5, 3, 7)
        ax32 = plt.subplot(5, 3, 8)
        ax33 = plt.subplot(5, 3, 9)
        ...
        diagrams.append(
            "ax13.plot(sim_res['time'],-(sim_res['bioreactor.culture.q[3]']+sim_res['bioreactor.culture.qG_over']), color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax13.plot(sim_res['time'],-sim_res['bioreactor.culture.q[3]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax23.plot(sim_res['time'],-(sim_res['bioreactor.culture.q[4]']+sim_res['bioreactor.culture.qGn_over']), color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax23.plot(sim_res['time'],-sim_res['bioreactor.culture.q[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax33.plot(sim_res['time'],sim_res['bioreactor.culture.q[1]'], color='b', linestyle=linetype)"
        )
    ...
    if plotType == "Textbook_3":
        ...
        diagrams.clear()
        diagrams.append(
            "ax[0].plot(t,sim_res['bioreactor.c[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[1].plot(t,sim_res['bioreactor.c[6]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[3].plot(t,sim_res['bioreactor.c[5]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[4].plot(t,sim_res['bioreactor.c[7]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[6].plot(t,sim_res['bioreactor.c[1]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[7].plot(t,sim_res['bioreactor.c[2]'], color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[9].plot(t,sim_res['bioreactor.inlet[1].F'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[10].plot(t,sim_res['bioreactor.c[8]'], color='g', linestyle=linetype)"
        )
        diagrams.append(
        ...
        diagrams.append(
            "ax[2].plot(t,-(sim_res['bioreactor.culture.q[4]']+sim_res['bioreactor.culture.qG_over']), color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[2].plot(t,-sim_res['bioreactor.culture.q[4]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(t,-(sim_res['bioreactor.culture.q[5]']+sim_res['bioreactor.culture.qGn_over']), color='r', linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(t,-sim_res['bioreactor.culture.q[5]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[8].plot(t,sim_res['bioreactor.culture.q[1]'], color='b', linestyle=linetype)"
        )
        diagrams.append(
            "ax[11].plot(t,sim_res['bioreactor.culture.q[8]'], color='g', linestyle=linetype)"
        )
